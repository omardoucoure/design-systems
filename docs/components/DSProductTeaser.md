...
> | Component YAML | [`docs/ai/components/DSProductTeaser.yaml`](../ai/components/DSProductTeaser.yaml) | AI decision guide: use_when, variants, padding, color mapping, rules |
