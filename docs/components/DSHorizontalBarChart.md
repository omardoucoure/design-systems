...
> | Component YAML | [`docs/ai/components/DSHorizontalBarChart.yaml`](../ai/components/DSHorizontalBarChart.yaml) | AI decision guide: use_when, variants, padding, color mapping, rules |
