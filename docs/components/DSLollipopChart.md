...
> | Component YAML | [`docs/ai/components/DSLollipopChart.yaml`](../ai/components/DSLollipopChart.yaml) | AI decision guide: use_when, variants, padding, color mapping, rules |
