...
> | Component YAML | [`docs/ai/components/DSCarouselDeck.yaml`](../ai/components/DSCarouselDeck.yaml) | AI decision guide: use_when, variants, padding, color mapping, rules |
