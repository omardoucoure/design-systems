...
> | Component YAML | [`docs/ai/components/DSStackedCardCarousel.yaml`](../ai/components/DSStackedCardCarousel.yaml) | AI decision guide: use_when, variants, padding, color mapping, rules |
