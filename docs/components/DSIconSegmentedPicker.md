...
> | Component YAML | [`docs/ai/components/DSIconSegmentedPicker.yaml`](../ai/components/DSIconSegmentedPicker.yaml) | AI decision guide: use_when, variants, padding, color mapping, rules |
